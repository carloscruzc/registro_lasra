        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-2">
                    ...
                    <li class="breadcrumb-item text-sm">Comprobantes de Estudiante</li>
                </ol>
            </nav>
    ...
    <div class="container-fluid py-">
        <div class="row mt-0 m-auto">
            ...
            <div class="card-header pb-0 p-3">
                    ...
                    <h4 class="mb-1 mt-4 text-left"><i class="fa fa-cash-register"></i> Comprobantes y estatus de validación del estudiante</h4>
                </div>
                                ...
                                <div class="table-responsive p-0">
                                    <table class="align-items-center mb-0 table table-borderless" id="user_list_table" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7" style="width:30%">Nombre Estudiante</th>
                                            <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Correo Electrónico</th>   
                                            <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7"><i class="fa fa-eye"></i>Ver Archivo</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php echo $tabla; ?>
